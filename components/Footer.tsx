    ...
    <footer className="w-full pt-20 pb-10" id="contact">
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-white-200 md:mt-10 my-5 text-center">
          Let's explore how design thinking can unlock breakthrough innovation. I'm available for speaking engagements, consulting, and collaboration.
        </p>
        <a href="mailto:alexandra.chen@stanford.edu">
          <MagicButton
            title="Get in Touch"
